                        ...
                        <div class="news__box container">
                                <div class=" news__box--item">
                                        ...
                                        <div class="news__box--description">
                                                <span
                                                        ...
                                                        >В AliExpress
                                                        представили портрет
                                                        типичного покупателя в
                                                        регионах
                                                </span>
                                                <div
                                                        class="news__box--description--p"
                                                >
                                                        Петербуржцы закупаются
                                                        пляжными сабо, омички —
                                                        теплыми тапочками, а в
                                                        Нижнем Новгороде
                                                        заказывают жилеты с
                                                        подогревом.
                                                </div>
                                ...
                                <div class=" news__box--item">
                                        ...
                                        <div class="news__box--description">
                                                <span
                                                        class="news__box--description--header"
                                                        >Аналитики AliExpress
                                                        показали типичный облик
                                                        жителей российских
                                                        городов
                                                </span>
                                                <div
                                                ...
                                                >
                                                        В AliExpress
                                                        проанализировали запросы
                                                        пользователей из семи
                                                        городов России и
                                                        составили портрет их
                                                        жителей по их
                                                        предпочтениям в одежде и
                                                        товарам ...
                                                </div>
                                        </div>
                                        <div class="data__box">
                                ...
                                <div class=" news__box--item">
                                        ...
                                        <div class="news__box--description">
                                                <span
                                                        class="news__box--description--header"
                                                        >«Почта России» ответила
                                                        на предложение о сборе
                                                        за покупки из-за рубежа
                                                </span>
                                                <div
                                                        class="news__box--description--p"
                                                >
                                                        В «Почте России»
                                                        прокомментировали
                                                        предложение ретейлеров
                                                        заменить пошлины на
                                                        дорогостоящие посылки
                                                        из-за рубежа единым
                                                        сбором в 15%.
                                                </div>
                                        </div>
                                ...
                                <div class="video__box--first">
                                        <div class="video__box--item">
                                                ...
                                                <div class="video__about__box">
                                                        <div
                                                                class="video__about--description"
                                                        >
                                                                <span
                                                                ...
                                                                <div
                                                                        class="video__about--description--p"
                                                                >
                                                                        Стороны
                                                                        обсудили
                                                                        возможное
