<template>
        <section class="checkout__order">
                ...
                <main class="checkout__order__container container">
                        ...
                        <form v-on:submit.prevent class="checkout__box">
                                ...
                                <div class="person__checkout">
                                        ...
                                        <div
                                                class="span__container span__container--last "
                                        >
                        ...
                        <section class="checkout__order__section">
                                ...
                                <div class="checkout__order__item__box">
                                        <div
                                                class="checkout__order__item--header"
                                        >
                                                <img
                                                        src="../assets/img/checkout__order/1.png"
                                                        alt="Item image"
                                                />
                                                <div
                                        ...
                                        >
                                                ...
                                                >
                                                        <span>Цвет:</span>
                                                        <img
                                                                src="../assets/img/checkout__order/color.png"
                                                                alt="Color image"
                                                        />
                                                </div>
                                        </div>
                                ...
                                <div class="checkout__order__price">
                                        <div
                                                class="checkout__order__price--total"
                                        >
                                                <span>Общая сумма:</span>
